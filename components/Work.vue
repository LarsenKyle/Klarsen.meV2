...
<section id="work">
  ...
  <div class="w-11/12 lg:w-9/12 mt-32 m-auto work-grid" >
    ...
    <div >
      ...
      <div class="flex justify-center ">
        <p class="bg-deep text-primaryText p-1 rounded-xl w-32 text-center m-2">E-commerce</p>
        <p class="bg-deep text-primaryText p-1 rounded-xl w-32 text-center m-2">Responsive</p>
      </div>
      <p class="text-primaryText text-lg px-4">This northern Michigan ice fishing manufacturer’s website needed a redesign.  Built with Nuxt.js their new E-commerce site combines the speed of server side rendering and JAM-stack hosting too ensure nobody is left waiting while preparing for ice fishing season.</p>
      <div class="w-7/12 m-auto mt-4 flex justify-center">
  ...
  <!-- Yoga Project -->
  <div class="w-11/12 lg:w-9/12 mt-32 m-auto work-grid reverse" >
    <div class="w-full">
    ...
    <div >
      ...
      <div class="flex justify-center ">
        <p class="bg-deep text-primaryText p-1 rounded-xl w-32 text-center m-2">Web-Application</p>
        <p class="bg-deep text-primaryText p-1 rounded-xl w-32 text-center m-2">Serverless</p>
      </div>
      <p class="text-primaryText text-left text-lg px-4">A yoga studio in Worland WY was looking for a way to track class attendance and generate monthly reports. It is straightforward and easy to use, even for those who are not so technologically inclined.</p>
      <div class="w-7/12 m-auto mt-4 flex justify-center reverse">
  ...
  <div class="w-11/12 lg:w-9/12 mt-32 m-auto work-grid " >
    ...
    <div >
      ...
      <div class="flex justify-center ">
        <p class="bg-deep text-primaryText p-1 rounded-xl w-32 text-center m-2">JAM-Stack</p>
        <p class="bg-deep text-primaryText p-1 rounded-xl w-32 text-center m-2">Design</p>
      </div>
      ...
      <div class="w-7/12 m-auto mt-4 flex justify-center">
         <button
          class="py-2 px-4 mr-2 bg-lightest focus:outline-none opacity-50  text-deep font-semibold rounded-sm  "
        >Visit Site</button>
